...
export const STRINGS: Record<Locale, Dictionary> = {
  en: {
    ...
    editPlan: "Edit plan",
    enterQuery: "Pose your question...",
    examples: "Try one of these:",
    export: "Export",
    finalReport: "Final report",
    followUpQuestions: "Follow-up questions",
    hello: "What shall we investigate?",
    ...
    quickSubtitle: "Self-hosted AI workstation — research, chat, code, and more.",
    quickPlaceholder: "How can I help you today?",
    ...
    disclaimer: "Quaesitor investigates, but verify findings.",
  },
  ar: {
    appName: "كويسيتور",
    ...
    quickSubtitle: "محطة ذكاء اصطناعي ذاتية الاستضافة — بحث، دردشة، برمجة، والمزيد.",
    quickPlaceholder: "كيف يمكنني مساعدتك اليوم؟",
    ...
    disclaimer: "كويسيتور يحقق، لكن تحقق من النتائج.",
  },
};
